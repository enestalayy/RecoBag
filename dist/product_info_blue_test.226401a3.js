...
(function(b) {
    ...
    function a(ax, aG) {
        ...
        this.adaptive = function() {
            ...
            if (i > q) i = q;
            if (u) ax.width("100%");
            else if (m != 0) ax.width(m);
            if (an != "fullscreen") {
                if (aE()) E.options.position = an;
                else E.options.position = E.options.mposition;
            }
        ...
        function aE() {
            var u = ax.offset();
            if (E.options.zoomWidth == "auto") aa = g;
            else aa = E.options.zoomWidth;
            if (E.options.zoomHeight == "auto") aj = i;
            else aj = E.options.zoomHeight;
            if (E.options.position.substr(0, 1) == "#") aD = b(E.options.position);
            else aD.length = 0;
        ...
        function e(u, v) {
            ...
            if (E.options.position != "lens" && E.options.lensCollision) {
                if (aw < 0) aw = 0;
                if (ad >= aq && aw > ad - aq) aw = ad - aq;
                if (ad < aq) aw = ad / 2 - aq / 2;
                if (au < 0) au = 0;
                if (ak >= aB && au > ak - aB) au = ak - aB;
                if (ak < aB) au = ak / 2 - aB / 2;
            }
        }
        function aH() {
            if (typeof ay != "undefined") ay.remove();
            if (typeof P != "undefined") P.remove();
            if (typeof t != "undefined") t.remove();
        }
        function N(u, aM) {
            ...
            if (E.options.rootOutput || E.options.position == "fullscreen") ac = ax.offset();
            else ac = ax.position();
            ...
            if (aD.length == 0 && E.options.position != "inside" && E.options.position != "fullscreen") {
                ...
                if (E.options.zoomWidth == "auto") aa = ad;
                else aa = E.options.zoomWidth;
                if (E.options.zoomHeight == "auto") aj = ak;
                else aj = E.options.zoomHeight;
                R += E.options.Yoffset;
            ...
            } else if (E.options.position == "inside" || E.options.position == "fullscreen") {
                aa = ad;
                aj = ak;
                P.css({
                    width: aa + "px",
            ...
            if (E.options.tint && E.options.position != "inside" && E.options.position != "fullscreen") o.css("background-color", E.options.tint);
            else if (D) o.css({
        ...
        this.openzoom = function(u) {
            ...
            Q.xon("load", function(aN) {
                ...
                } else if (E.options.fadeIn) P.fadeTo(300, 1);
                else P.css({
                    opacity: 1
                });
                if (E.options.title && j != "") {
                    if (E.options.fadeIn) t.fadeTo(300, 1);
                    else t.css({
                        opacity: 1
                    });
                }
        ...
        this.init = function(u) {
            ...
            if (E.options.rootOutput) M = b("body");
            else M = ax.parent();
            ...
            if (E.options.adaptive) b(window).xon("load", function() {
                m = ax.width();
                q = ax.height();
                E.adaptive();
            ...
            this.each(function(h) {
                if (g.length == 1) {
                    ...
                    if (b(this).is(g[0]) && h == 0) {
                        ...
                        if (typeof c.data("xzoom") !== "undefined") return c.data("xzoom");
                        c.x = new a(c, e);
                    } else if (typeof c.x !== "undefined" && !b(this).is(g[0])) {
                        d = b(this);
                        c.x.xappend(d);
                    }
                }
            });
        } else this.each(function(h) {
            if (h == 0) {
                c = b(this);
                if (typeof c.data("xzoom") !== "undefined") return c.data("xzoom");
                c.x = new a(c, e);
...
//# sourceMappingURL=product_info_blue_test.226401a3.js.map
